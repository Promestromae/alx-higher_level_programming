...
attribute position and the corresponding property and setter method
"""
...
class Square:
    ...
    @property
    def size(self):
        """This method returns the size of square"""
        return self.__size

    @size.setter
    def size(self, value):
        """This method sets the size of square"""
    ...
    @property
    def position(self):
        """This method returns the position of square"""
        return self.__position

    @position.setter
    def position(self, value):
        """This method sets the position of square"""
